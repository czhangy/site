                ...
                <div className={styles.info}>
                    <div className={styles.songInfo}>
                        ...
                        <div className={styles.text}>
                            <p className={styles.song}>{spotifyData.songName}</p>
                            <p className={styles.artist}>{spotifyData.artist}</p>
                        </div>
                    </div>
                    <Link className={styles.link} href={spotifyData.spotifyUrl} target="_blank">
